...
export default function Finishing() {
    ...
    const goDetail = () => {
        ...
        if (!spk) return;
        navigate(`/method/update-divisi/finishing/detail-lembar-kerja?spk=${encodeURIComponent(spk)}`);
    };
    ...
    return (
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Typography variant="h6" fontWeight={700}>Divisi Finishing</Typography>
                <TextField
                required
                id='lembar-finishing'
